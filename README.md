...
- 🚀 **2026-05-28 · [v0.1.4](https://github.com/tile-ai/TileRT/releases/tag/v0.1.4) Released**. A major performance upgrade for both **DeepSeek-V3.2** and **GLM-5** — significantly faster end-to-end decoding on 8× B200 while keeping model quality unchanged.
...
| ---------------- | --------------------------------------------------- |
| GPU              | 8× NVIDIA **B200**                                  |
| NVIDIA driver    | Supports **CUDA 13.0** runtime                      |
