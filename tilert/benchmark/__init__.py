...
class CellStats:
    ...
    tok_s: float = 0.0
    iters_s: str = "-"  # "xxx.x it/s" or "xxx.x/yyy.y it/s" (pre/post-2048 for Long)
    # Acceptance rate: "mean/min/max" for MTP, "-" for non-MTP
    acc_rate: str = "-"


# {mode_label: {column_name: CellStats}}
...
# {mode_label: {column_name: [PerStepData per iteration]}}
