...
def alloc_misc_ws(
    ...
    """Allocate a misc workspace tensor via C++ binding.

    The workspace unifies profiling logs and VM scratch memory (instructions +
    global barriers) into a single contiguous allocation.  Use this instead of
    ``get_profile_log_tensor`` for new code.
