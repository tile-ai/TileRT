...
class PureMlaV2(SerializableTileRTModule):
    ...
    def __init__(
        ...
        # Op 6: GEMV + 8-GPU AllReduce + residual
        # Both DSV3.2 and GLM5 use FP16MMA (128-CTA HMMA).
    ...
    def init_random_weights(self) -> None:
        ...
        PureMlaV2 needs HMMA format for ProjQWkvb and ProjOWkvb.
        """
    ...
    def init_tilert_weights(self, state_dict: dict[str, torch.Tensor]) -> None:
        ...
        # Now init the two ops with HMMA-packed weights.
        for op in [self.projq_wqb, self.projo_wkvb]:
            op_state_dict = {}
