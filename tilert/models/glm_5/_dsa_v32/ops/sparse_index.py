...
def sparse_index(
    ...
    *,
    ...
    Args:
        ...
        compute_kernel_type (str): Kernel type ("bf16" for both DSv32 and GLM5).
        model_arch (str): Model architecture ("deepseek_v3_2" or "glm_5").
    ...
    # Auto-detect model_arch from head count if using default
