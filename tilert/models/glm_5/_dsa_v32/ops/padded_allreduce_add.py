...
GPU 0 participates in the 8-GPU AllReduce with a zero partial sum (no GEMV),
then applies residual add. Derived from UnprojOAllreduce by removing GEMV.
"""
...
class PaddedAllReduceAdd(TileRTModule):
    ...
    def __init__(
        ...
        # Persistent zero-filled partial buffer
