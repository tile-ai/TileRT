...
The C++ qkv_rope_op dispatches internally by q_pe.shape[2].
"""
...
def qkv_rope(
    ...
    Unified for deepseek_v3_2 (16 heads) and glm_5 (8 heads).
    The C++ op dispatches internally by pe_cache.shape[2].
