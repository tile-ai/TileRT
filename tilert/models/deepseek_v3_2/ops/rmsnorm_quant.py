...
Dispatches by hidden_in.shape[-1] internally via a single rmsnorm_quant_op / rmsnorm_op.
"""
...
def rmsnorm_quant(
    ...
    *,
    ...
    Unified for deepseek_v3_2 (dim=7168) and glm_5 (dim=6144). A single
    rmsnorm_quant_op / rmsnorm_op dispatches internally based on dim.
