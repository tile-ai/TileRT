...
class WeightConverter:
    ...
    def __init__(
        ...
        # Cast to ModelArgs: both DSv32 and GLM-5 ModelArgs are structurally
        # identical for the converter's purposes (it only reads dims / layer
        # counts). The dsv32 op classes used below are typed against ModelArgs
        # but accept GLM-5 args at runtime via duck typing.
